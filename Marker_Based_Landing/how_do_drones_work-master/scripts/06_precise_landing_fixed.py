...
while True:                
    ...
    if marker_found or once_marker_found:
        ...
        if time.time() >= time_0 + 1.0/freq_send:
            ...
            marker_lat, marker_lon = 0,0
            if once_marker_found == 0:
                marker_lat, marker_lon  = get_location_metres(uav_location, north*0.01, east*0.01)
                
            #-- If angle is good, descend
            if check_angle_descend(angle_x, angle_y, angle_descend) or once_marker_found ==1:
