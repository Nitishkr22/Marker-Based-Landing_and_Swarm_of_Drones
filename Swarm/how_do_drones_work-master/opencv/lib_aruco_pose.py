...
class ArucoSingleTracker():
    def __init__(self,
        ...
        self._aruco_dict  = aruco.getPredefinedDictionary(aruco.DICT_5X5_100)
...
if __name__ == "__main__":
    ...
    calib_path  = ""
    camera_matrix   = np.loadtxt(calib_path+'cameraMatrix_640_480.txt', delimiter=',')
    camera_distortion   = np.loadtxt(calib_path+'cameraDistortion_640_480.txt', delimiter=',')                                      
    aruco_tracker = ArucoSingleTracker(id_to_find=10, marker_size=27, show_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
